...
<body>
    ...
    <section class="packages">
        ...
        <h1 class="heading-title">Destinos top</h1>
        ...
        <div class="box-container">
            <div class="box">
                ...
                <div class="content">
                    ...
                    <p>fasdffdsfadsgsrwtrbxbvbvcb</p>
        ...
        <div class="box">
                ...
                <div class="content">
                    <h3>Lago de Atitlan</h3>
                    <p>sjflsdjflksjdkfhskjdfhknvkjlchv
                        vksdfjdsfjldsjf
                    </p>
                    <a href="book.php" class="btn">Registrate Ahora</a>
                </div>
            ...
            <div class="box">
                ...
                <div class="content">
                    ...
                    <p>fasdfflsjdf;lsjdfl;jsdfl;jsadlfjsdhfkslfjl
                        ksdjfsdjflksdjfklshdfklhwlih fsd</p>
                    <a href="book.php" class="btn">Registrate Ahora</a>
                </div>
            </div>
        </div>

            <div class="load-more"><span class="btn">Leer mas</span></div>
    </section>
